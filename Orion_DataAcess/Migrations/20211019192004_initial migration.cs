    ...
    public partial class initialmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_contractPackages", x => new { x.ContractId, x.PackageId });
                    table.ForeignKey(
                        name: "FK_contractPackages_Contracts_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_contractPackages_Packages_PackageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_contractPackages_PackageId",
